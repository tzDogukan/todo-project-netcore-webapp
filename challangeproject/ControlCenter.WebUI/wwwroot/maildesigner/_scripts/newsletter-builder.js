...
$("#add-footer").hover(function() {
 ...
 $(".newsletter-builder-area-center-frame-buttons-content-tab").hover(
  function() {
    $(this).append('<div class="newsletter-builder-area-center-frame-buttons-content-tab-add"><i class="fa fa-plus"></i>&nbsp;Ekle</div>');
  ...
  function() {
	...
	$("#sim-edit-link .sim-edit-box-buttons-save").click(function() {
	  ...
	  $(this).parent().parent().slideUp(500)
		...
		//edit link2
	if(big_parent.attr("data-type")=='linkicon'){
	$("#sim-edit-linkicon .url").val(big_parent.attr("href"));
	$("#sim-edit-linkicon").fadeIn(500);
	$("#sim-edit-linkicon .sim-edit-box").slideDown(500);
	
	$("#sim-edit-linkicon .sim-edit-box-buttons-save").click(function() {
	  $(this).parent().parent().parent().fadeOut(500)
	  $(this).parent().parent().slideUp(500)
	   
		big_parent.attr("href",$("#sim-edit-linkicon .url").val());
...
$("#newsletter-builder-sidebar-buttons-bbutton").click(function(){
	...
	$.ajax({
	  url: "_css/bootstrapnewsletter.css"
	}).done(function(data) {

	
export_content = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns:v="urn:schemas-microsoft-com:vml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/><link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900,200italic,300italic,400italic,600italic,700italic,900italic" rel="stylesheet" type="text/css"><link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"></head><style type="text/css">'+data+'</style><body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"><table style="display:none!important;"><tr><td><div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">Pre-header for the newsletter template</div></td></tr></table>'+preload_export_html+'</body></html>';
